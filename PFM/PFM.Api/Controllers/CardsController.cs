...
using PFM.Application.UseCases.Cards.Commands.DeactivateCard;
...
namespace PFM.Api.Controllers
{
    ...
    public class CardsController : ControllerBase
    {
        ...
        {
            var cmd = new DeactivateCardCommand(id);
            var op = await _mediator.Send(cmd);
            ...
            return StatusCode(op.code, "Card successfully deactivated");
        }
    }
}
